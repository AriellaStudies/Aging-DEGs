...
NCBI GEO was searched for expression datasets on 03/02/2021 for "aging", filtered to mammalian species, with 104 results. Results were exported as a detailed text file, then parsed into a dataframe using Python below.
```{python cache=TRUE, message = FALSE, warning=FALSE}
