...
```
Primate datasets using human microarray platforms?
```{r}
...
# 6. Dataset Characteristics (R and Python)
...
Tissue_df = pd.DataFrame.from_dict(tissue_dict, orient='index')
Tissue_df = Tissue_df.sort_values(by=0, ascending=False)
print(Tissue_df)

Tissue_df.to_csv("Tissue_DF.csv")
```
