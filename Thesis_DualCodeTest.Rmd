...
* O Convert dictionary to dataframe and/or csv
* O Convert loop to function
...
```{python}
#Play here
#Can I call a dictionary from a previous python chunk?
