...
install_if_missing("umap")
install_if_missing("reticulate")
install_if_missing("homologene")
install_if_missing("ggplot2")
install_if_missing("dplyr")
install_if_missing("svglite")
```
Open Libraries
```{r include=FALSE}
library(GEOquery)
...
if (!virtualenv_exists(envname)) {
  ...
  virtualenv_install(envname, packages = c("pandas", "regex", "seaborn", "matplotlib"))
}
...
*Note: adjust HERE to change the score limit for section 4B*
```{python}
